...
var require_paper_full = __commonJS({
  "node_modules/paper/dist/paper-full.js"(exports, module) {
    var paper = (function(self2, undefined) {
      self2 = self2 || require_self();
      var window = self2.window, document = self2.document;
          ...
          setIndex: function(index) {
            ...
            if (children) {
              parent.insertChildren(
                index in children ? index : undefined,
                [this]
              );
            }
          },
      ...
      var CanvasView = View.extend({
        ...
        initialize: function CanvasView2(project, canvas) {
          ...
          if (!/^off|false$/.test(PaperScope.getAttribute(canvas, "hidpi"))) {
            var deviceRatio = window.devicePixelRatio || 1, backingStoreRatio = DomElement.getPrefixed(
              ctx,
...
export default require_paper_full();
